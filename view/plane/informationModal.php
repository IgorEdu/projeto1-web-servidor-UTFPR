<div class="modal fade" id="informationModal" tabindex="-1" aria-labelledby="planeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header" style="justify-content: center;">
                <h1 class="modal-title" style="background-color: transparent;" id="planeModalLabel"><i class="bi bi-check-circle"></i></h1>
            </div>
